        ...
        <section className="ScoreTable-section ScoreTable-section-lower">
          ...
          <table cellSpacing="0">
            <tbody>
              ...
              <RuleRow name="Four of Kind" score={scores.fourOfKind} description={threeOfKind.description} doScore={evt => doScore("fourOfKind", fourOfKind.evalRoll)} />
              <RuleRow name="Full House" score={scores.fullHouse} description={threeOfKind.description} doScore={evt => doScore("fullHouse", fullHouse.evalRoll)} />
